...
const inviteCodes = [
    //'' 删除作者的
    'T014v_x3QBcZ_FzXIACjVQmoaT5kRrbA@T0205KkcN2tzlROMZFKo1oFvCjVQmoaT5kRrbA@T0225KkcRk1L8lLRckj1l6QKdgCjVQmoaT5kRrbA@T014aFDzlb2M91TeJACjVQmoaT5kRrbA@T0225KkcRRpKo1SCck-ikvdYIgCjVQmoaT5kRrbA'
];
...
function readShareCode() {
    ...
    return new Promise(async resolve => {
        $.get({
            url: "https://gitee.com/Soundantony/RandomShareCode/raw/master/JD_SGMH.json",
            headers: {
