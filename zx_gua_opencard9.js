...
没有适配加购变量 所以是不加购
————————————————
入口：[8.11-8.15 星动七夕 纵享丝滑 (https://lzdz1-isv.isvjcloud.com/dingzhi/dz/openCard/activity/1760960?activityId=078b967203634b208aaf65085d91a970&shareUuid=9103923f2a474359a2c7c7474bab1fc4)]
============Quantumultx===============
[task_local]
#8.11-8.15 星动七夕 纵享丝滑
39 0,22 8-15 8 * https://raw.githubusercontent.com/xyzonecodes/MyActions/main/zx_gua_opencard9.js, tag=8.11-8.15 星动七夕 纵享丝滑, enabled=true
================Loon==============
[Script]
cron "39 0,22 8-15 8 *" script-path=https://raw.githubusercontent.com/xyzonecodes/MyActions/main/zx_gua_opencard9.js,tag=8.11-8.15 星动七夕 纵享丝滑
===============Surge=================
8.11-8.15 星动七夕 纵享丝滑 = type=cron,cronexp="39 0,22 8-15 8 *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/xyzonecodes/MyActions/main/zx_gua_opencard9.js
============小火箭=========
8.11-8.15 星动七夕 纵享丝滑 = type=cron,script-path=https://raw.githubusercontent.com/xyzonecodes/MyActions/main/zx_gua_opencard9.js, cronexpr="39 0,22 8-15 8 *", timeout=3600, enable=true
*/
...
!(async () => {
  ...
  $.shareUuid = '9103923f2a474359a2c7c7474bab1fc4'
