...
var appId = 10028,
    fingerprint, token, enCryptMethodJD;
var res = '',
    shareCodes = [];
var homePageInfo;
...
!(function() {
    return __awaiter(void 0, void 0, void 0, function() {
        return __generator(this, function(_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/ , zx_ts_common_1.default.requestAlgo()];
                case 1:
                    _a.sent();
    ...
    return new Promise(function(resolve) {
        return __awaiter(_this, void 0, void 0, function() {
            ...
            return __generator(this, function(_b) {
                switch (_b.label) {
                    case 0:
                        return [4 /*yield*/ , taskAPI('GetUserTaskStatusList', 'bizCode,dateType,source')];
                    case 1:
                        tasks = _b.sent();
                        doTaskRes = { ret: 1 };
    ...
    return new Promise(function(resolve, reject) {
        return __awaiter(_this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/ , zx_ts_common_1.default.getBeanShareCode(zx_ts_common_1.default.cookie)];
                    case 1:
                        bean = _a.sent();
