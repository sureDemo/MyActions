            ...
            try {
                if (err) {
                    ...
                    if (data) {
                        ...
                        if (data.data && data.data.userInfo && data.data.userInfo.baseInfo) {
                            let txt = `cookie正常\t 昵称:${data.data.userInfo.baseInfo.nickname}\t等级名称:${data.data.userInfo.baseInfo.levelName}\t用户等级:${data.data.userInfo.baseInfo.userLevel}\n`;
                            $.log(txt);
                            allMessage += txt
                            $.isLogin = true
                        }
