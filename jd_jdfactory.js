...
const inviteCodes = [
    ...
    'T014v_x3QBcZ_FzXIACjVWnYaS5kRrbA@T0205KkcN2tzlROMZFKo1oFvCjVWnYaS5kRrbA@T0225KkcRk1L8lLRckj1l6QKdgCjVWnYaS5kRrbA@T014aFDzlb2M91TeJACjVWnYaS5kRrbA@T0165rgiHklDsAqWZUuqCjVWnYaS5kRrbA@T0225KkcRRpKo1SCck-ikvdYIgCjVWnYaS5kRrbA'
];
!(async() => {
    await requireConfig();
    if (!cookiesArr[0]) {
...
function readShareCode() {
    ...
    return new Promise(async resolve => {
        $.get({
            url: "https://wuzhi03.coding.net/p/dj/d/RandomShareCode/git/raw/main/JD_Factory.json",
            headers: {
